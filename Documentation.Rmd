...
### Cost Computing
Der letzte Schritt ist die Berechnung der Gesamtkosten. Hierfür werden zunächst die Matrizen modifiziert, indem alle Matrix-Einträge durch die Summe der jeweiligen Spalte geteilt werden.
...
Anschließend wird das EAD rückwärts zurückgerechnet, mit den modifizierten Matrizen beginnend mit RCC.
